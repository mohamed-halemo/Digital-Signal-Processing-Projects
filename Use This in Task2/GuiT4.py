...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Newtabbtn.setGeometry(QtCore.QRect(11, 11, 93, 28))
        self.Newtabbtn.setObjectName("Newtabbtn")
        self.Removetabbtn = QtWidgets.QPushButton(self.centralwidget)
        self.Removetabbtn.setGeometry(QtCore.QRect(100, 10, 93, 28))
        self.Removetabbtn.setObjectName("Removetabbtn")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(330, 10, 332, 28))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(10, 40, 1291, 961))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 830, 1031, 86))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.verticalSlider = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider.setObjectName("verticalSlider")
        self.gridLayout_3.addWidget(self.verticalSlider, 0, 0, 1, 1)
        self.verticalSlider_2 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_2.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_2.setObjectName("verticalSlider_2")
        self.gridLayout_3.addWidget(self.verticalSlider_2, 0, 1, 1, 1)
        self.verticalSlider_3 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_3.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_3.setObjectName("verticalSlider_3")
        self.gridLayout_3.addWidget(self.verticalSlider_3, 0, 2, 1, 1)
        self.verticalSlider_4 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_4.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_4.setObjectName("verticalSlider_4")
        self.gridLayout_3.addWidget(self.verticalSlider_4, 0, 3, 1, 1)
        self.verticalSlider_5 = QtWidgets.QSlider(self.layoutWidget1)
        ...
        self.verticalSlider_6 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_6.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_6.setObjectName("verticalSlider_6")
        self.gridLayout_3.addWidget(self.verticalSlider_6, 0, 5, 1, 1)
        self.verticalSlider_7 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_7.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_7.setObjectName("verticalSlider_7")
        self.gridLayout_3.addWidget(self.verticalSlider_7, 0, 6, 1, 1)
        self.verticalSlider_8 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_8.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_8.setObjectName("verticalSlider_8")
        self.gridLayout_3.addWidget(self.verticalSlider_8, 0, 7, 1, 1)
        self.verticalSlider_9 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_9.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_9.setObjectName("verticalSlider_9")
        self.gridLayout_3.addWidget(self.verticalSlider_9, 0, 8, 1, 1)
        self.verticalSlider_10 = QtWidgets.QSlider(self.layoutWidget1)
        self.verticalSlider_10.setOrientation(QtCore.Qt.Vertical)
        self.verticalSlider_10.setObjectName("verticalSlider_10")
        self.gridLayout_3.addWidget(self.verticalSlider_10, 0, 9, 1, 1)
